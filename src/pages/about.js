...
const AboutPage = ({ data }) => (
  <Layout>
    <SEO title="About" keywords={[`about`, `montezuma`, `media`, `david`, `king`]}/> 
    <Row className="no-gutters align-items-center pl-lg-5 pl-xl-5" style={{minHeight:`100vh`}}>
      <Col xs="12" md="7" xl="8">
        <div className="pt-xl-4">
          ...
          <p style={{color:`#b8b8b8`, marginRight:`15px`}}>
            <strong>Founded by David King</strong><br/>
            David King is a professional photographer from Silverthorne, Colorado who is passionate about sharing the world from new perspectives.
            ...
            The idea that the most spectacular and beautiful parts of the world could be shared with anyone at anytime is an idea that would stick with David for the rest of his life.
            ...
            Intreagued with the complexities of the world and life its self, as David grew older he began venturing out further from his home town of Houston, Texas with the hopes of discovering and sharing the best that the world has to offer.
            ...
            Being inspired by the Continental Divide which surpasses 14,000 feet in elevation and forms the backdrop of Silverthorne, David founded Montezuma Media naming it after the old mining town "Montezuma", which sits on the divide.
            <br/><br/>
      ...
      <Col xs="12" sm="8" md="5" xl="4" className="offset-sm-2 offset-md-0 p-md-4">
        <Img fluid={data.backgroundImage.childImageSharp.fluid} alt="David King in Uzupis"/>
      </Col>
    </Row>
  </Layout>
)
